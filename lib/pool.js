...
//                    emitLog('Block notification via RPC polling');
		 emitLog( _this.jobManager.currentJob.rpcData.height + ' New Block notification via P2P');
...
//        emitLog('New Block notification via ' + sourceTrigger);
	 emitLog('New Block ' + _this.jobManager.currentJob.rpcData.height + ' notification via ' + sourceTrigger);
